...
% Ploting 3D shape
figure(4), hold off, plot3(S(2, :), S(3, :), S(1, :), 'r.'), axis equal
figure(5), hold off, plot3(S(1, :), S(2, :), S(3, :), 'r.'), axis equal
figure(6), hold off, plot3(S(3, :), S(2, :), S(1, :), 'r.'), axis equal
...
figure(1), hold off, plot3(k(:, 2), k(:, 3), k(:, 1));
